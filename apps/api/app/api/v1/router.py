...
from app.api.v1.endpoints import chat, episodes, gists, memories, rawlogs, reinjection, retrieval, search_logs, sessions, turns
...
api_router.include_router(search_logs.router, prefix="/search-logs", tags=["search-logs"])
